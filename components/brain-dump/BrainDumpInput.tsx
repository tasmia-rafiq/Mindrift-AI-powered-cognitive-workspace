      ...
      <div className="relative z-10 grid grid-cols-1 gap-8 lg:grid-cols-[1.2fr_0.8fr]">
        <div>
          ...
          <div className="relative mt-5">
            <div className="absolute -inset-1 rounded-[30px] bg-linear-to-r from-cyan-400/5 via-white/5 to-violet-400/10 blur-xl" />

            <textarea
              value={input}
              onChange={(e) => setInput(e.target.value)}
              placeholder="Example: I need to finish portfolio, reply to client, attend meeting, fix a bug, complete assignment... and I feel tired."
              className="relative min-h-80 w-full resize-none rounded-[30px] border border-white/10 bg-black/30 p-6 text-lg font-light! leading-8 text-zinc-200 outline-none placeholder:text-zinc-500 focus:border-white/20"
            />
          </div>
